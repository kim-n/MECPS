...
admin = User.create({activated: true, email: 'aabraha3@schools.nyc.gov', name: 'Abraham', password: 'Abraham' })
admin.update_attribute("admin", 1)

link = Link.new
link.page_html: "<h1> Medgar Evers College Preparatory School </h1>\r\n<a href=\"http://mecps.org/\" target=\"_window\">We're on the web!</a>\r\n\r\n\r\n<h1> Libraries</h1>\r\n<a href=\"http://www.bklynpubliclibrary.org/\" target=\"_window\">Brooklyn Public Library</a>\r\n<a href=\"http://www.cuny.edu/libraries.html\" target=\"_window\">City University of New York</a>\r\n<a href=\"http://www.loc.gov/index.html\" target=\"_window\">Library of Congress</a>\r\n<a href=\"http://www.mec.cuny.edu/library/\" target=\"_window\">Medgar Evers College</a>\r\n<a href=\"http://www.nypl.org/\" target=\"_window\">New York Public Library</a>\r\n<a href=\"http://www.queenslibrary.org/\" target=\"_window\">Queens public library</a>\r\n"
link.save

about = About.new
about.page_html: "Ms. Abraham, Librarian\r\nLibrary Phone: 718-703-5400 ext. 5100\r\nLibrary Email: <a href=\"mailto:aabraha3@schools.nyc.gov?Subject=Regarding MECPS Library Site\">Send Mail</a>\r\n" 
about.save


# user = User.create({activated: true, email: 'jenny@site.com', name: 'Jenny Renny', password: '123456', avatar: 'http://seeyprofile.com/design/main/images/default_avatar_female.jpg'})
# user = User.create({activated: true, email: 'tim@site.com', name: 'Tim Jim', password: '123456', avatar: 'http://www.dotnetcodesg.com/Register/UserImage/Default.png'})
# user = User.create({activated: true, email: 'dave@site.com', name: 'Dave Cave', password: '123456'})
# user = User.create({activated: true, email: 'mark@site.com', name: 'Mark Park', password: '123456'})
# 
# 
# book1 = Book.create({
#   title: "Harry Potter", 
