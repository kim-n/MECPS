...
admin = User.create({activated: true, email: 'admin@site.com', name: 'Admin', password: '123456', avatar: 'http://www.murketing.com/journal/wp-content/uploads/2009/04/8tracks.jpg' })
